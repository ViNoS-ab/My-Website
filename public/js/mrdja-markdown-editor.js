(function () {
  window.mrdjaMDE = function (taSelector, buttons) {
    ...
    //The main function
    (function () {
      //Usage example: createMDE("#input", buttons);
      ...
      ta.addEventListener("input", () => {
        if (
          ta.value.length - txtHistory.current().length > 1 ||
          ta.value.length - txtHistory.current().length < -1
        ) {
    ...
    function bold() {
      if (mrdjaMDE.isHelp === false) {
        ...
        if (selstart === selend) {
          ...
          mrdjaMDE.txtarea.selectionStart = mrdjaMDE.txtarea.selectionEnd =
            selstart + 2;
    ...
    function codeBlock() {
      if (mrdjaMDE.isHelp === false) {
        ...
        if (selstart === selend) {
          ...
          var text = txt.substring(selstart, selend);
          var after = txt.substring(selend, txt.length);
          mrdjaMDE.txtarea.value =
            before + "\n```lang\n" + text + "\n```\n" + after;
          mrdjaMDE.txtarea.selectionStart = mrdjaMDE.txtarea.selectionEnd =
            selstart + text.length + 9;
          mrdjaMDE.txtarea.focus();
          previewUpdateAndRecord();
        }
      }
    ...
    function link() {
      if (mrdjaMDE.isHelp === false) {
        ...
        if (selstart === selend) {
          ...
          var after = txt.substring(selend, txt.length);
          mrdjaMDE.txtarea.value =
            before + '[link](https://www.example.com "link")' + after;
          ...
          var after = txt.substring(selend, txt.length);
          mrdjaMDE.txtarea.value =
            before + "[" + text + '](https://www.example.com "link")' + after;
    ...
    function embed() {
      if (mrdjaMDE.isHelp === false) {
        ...
        if (selstart === selend) {
          ...
          var after = txt.substring(selend, txt.length);
          mrdjaMDE.txtarea.value =
            before + '![image](https://www.example.com "image")' + after;
          ...
          var after = txt.substring(selend, txt.length);
          mrdjaMDE.txtarea.value =
            before + "![" + text + '](https://www.example.com "image")' + after;
    ...
    function resize() {
      if (mrdjaMDE.split.getSizes()[0] > 50) {
        ...
        mrdjaMDE.split.getSizes()[0] <= 50 &&
        mrdjaMDE.split.getSizes()[0] > 2
      ) {
